...
/*
 * CUSTOM CHANGE: All \icon-chevron-*\ classes have been replaced with \glyphicon glyphicon-chevron-\
 */
...
//// END CUSTOM CHANGE
    ...
    updateWidget: function() {
      ...
      var hour = this.hour.toString().length === 1 ? '0' + this.hour : this.hour,  // CUSTOM CHANGE: original `this.hour`
